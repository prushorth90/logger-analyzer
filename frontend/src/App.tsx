import { Activity, ArrowUpRight, Braces, ChevronRight, CircleHelp, LayoutDashboard, Terminal } from 'lucide-react'
  ...
  return (
    <div className="workspace">
      ...
      <div className="main-shell">
        <header className="topbar"><div>Workspace<ChevronRight size={14} /><span>System health</span></div><span className="environment"><span className="local-dot" />Local environment</span></header>
        <main><Routes>
